Page({
  ...
  */
  onShow: function () {
    ...
    if (d == 0) this.data.D = this.data.COORDS['D28']
    if (d == 1) this.data.D = this.data.COORDS['D28']
    if (d == 2) this.data.D = this.data.COORDS['D27']
    if (d == 3) this.data.D = this.data.COORDS['D26']
    if (d == 4) this.data.D = this.data.COORDS['D25']
    if (d == 5) this.data.D = this.data.COORDS['D24']
    if (d == 6) this.data.D = this.data.COORDS['D22']
    if (d == 7) this.data.D = this.data.COORDS['D21']
    if (d == 8) this.data.D = this.data.COORDS['D19']
    if (d == 9) this.data.D = this.data.COORDS['D18']
    if (d == 10) this.data.D = this.data.COORDS['D14']
    if (d == 11) this.data.D = this.data.COORDS['D12']
    if (d == 12) this.data.D = this.data.COORDS['D11']
    if (d == 13) this.data.D = this.data.COORDS['D9']
    if (d == 14) this.data.D = this.data.COORDS['D7']
    if (d == 15) this.data.D = this.data.COORDS['D5']
    if (d == 16) this.data.D = this.data.COORDS['D4']
    if (d == 17) this.data.D = this.data.COORDS['D3']
    if (d > 17 && d < 27) this.data.D = this.data.COORDS['D2']
    if (d == 27) this.data.D = this.data.COORDS['D1']

    if (i == 0) this.data.I = this.data.COORDS['I28']
    if (i == 1) this.data.I = this.data.COORDS['I26']
    if (i == 2) this.data.I = this.data.COORDS['I25']
    if (i == 3) this.data.I = this.data.COORDS['I23']
    if (i == 4) this.data.I = this.data.COORDS['I20']
    if (i == 5) this.data.I = this.data.COORDS['I16']
    if (i == 6) this.data.I = this.data.COORDS['I12']
    if (i == 7) this.data.I = this.data.COORDS['I10']
    if (i == 8) this.data.I = this.data.COORDS['I7']
    if (i == 9) this.data.I = this.data.COORDS['I4']
    if (i == 10) this.data.I = this.data.COORDS['I3']
    if (i > 10 && d < 26) this.data.I = this.data.COORDS['I2']
    if (i >= 26) this.data.I = this.data.COORDS['I1']

    if (s == 0) this.data.S = this.data.COORDS['S28']
    if (s == 1) this.data.S = this.data.COORDS['S26']
    if (s == 2) this.data.S = this.data.COORDS['S22']
    if (s == 3) this.data.S = this.data.COORDS['S19']
    if (s == 4) this.data.S = this.data.COORDS['S15']
    if (s == 5) this.data.S = this.data.COORDS['S12']
    if (s == 6) this.data.S = this.data.COORDS['S9']
    if (s == 7) this.data.S = this.data.COORDS['S7']
    if (s == 8) this.data.S = this.data.COORDS['S5']
    if (s == 9) this.data.S = this.data.COORDS['S4']
    if (s == 10) this.data.S = this.data.COORDS['S3']
    if (s > 10 && d < 27) this.data.S = this.data.COORDS['S2']
    if (s >= 27) this.data.S = this.data.COORDS['S1']

    if (c == 0) this.data.C = this.data.COORDS['C28']
    if (c == 1) this.data.C = this.data.COORDS['C27']
    if (c == 2) this.data.C = this.data.COORDS['C26']
    if (c == 3) this.data.C = this.data.COORDS['C25']
    if (c == 4) this.data.C = this.data.COORDS['C24']
    if (c == 5) this.data.C = this.data.COORDS['C22']
    if (c == 6) this.data.C = this.data.COORDS['C20']
    if (c == 7) this.data.C = this.data.COORDS['C16']
    if (c == 8) this.data.C = this.data.COORDS['C14']
    if (c == 9) this.data.C = this.data.COORDS['C11']
    if (c == 10) this.data.C = this.data.COORDS['C8']
    if (c == 11) this.data.C = this.data.COORDS['C6']
    if (c == 12) this.data.C = this.data.COORDS['C4']
    if (c == 13) this.data.C = this.data.COORDS['C3']
    if (c > 13 && c < 26) this.data.C = this.data.COORDS['C2']
